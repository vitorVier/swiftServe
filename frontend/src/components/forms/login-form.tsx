        ...
        <Card className="bg-app-card border border-app-border w-full max-w-md mx-auto shadow-xl transition-all duration-300 hover:border-brand-primary/30">
            ...
            <CardContent>
                <form className="space-y-4" action={formAction}>
                    ...
                    {state?.error && (
                        <div className="text-sm text-red-500 rounded-md px-0.5 -mt-2">
                            {state.error}
                        </div>
                    )}
                    ...
                    <div className="pt-2">
                        <p className="text-center text-sm text-gray-400">
                            ...
                            <Link href="/register" className="text-brand-primary font-medium hover:underline hover:text-brand-primary/80 transition-colors">
                                Crie uma conta.
                            </Link>
                        </p>
                    </div>
